...
public class ValueObjectGenerator extends JFrame {
    ...
    private void generateCode() throws IOException {
        ...
        String finalKeyword1 = finalCheckBox.isSelected() ? "final " : "";
        StringBuilder classCode = new StringBuilder();
        classCode.append("public ").append(finalKeyword1).append("class ").append(capitalize(className)).append(" {\n\n");
        ...
        // Generating Builder class within Value Object
        ...
        classCode.append("\n");
        classCode.append(valueObject.generateBuilderGet());
        classCode.append(valueObject.generateBuilderBuild());
        classCode.append("\t}\n");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(ValueObjectGenerator::new);
    }
}
